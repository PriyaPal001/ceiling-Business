<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <div class="flex justify-between items-end gap-4 mb-6">
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold">Collection of Lahenga</h2>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 md:gap-x-6 gap-y-8">
        ...
        <div>
          <a href="/Lahenga/1" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/f2/cb/a0/f2cba03305d2f9630e018bc7a1a2986c.jpg" loading="lazy" alt="Photo by Rachit Tank" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
        ...
        <div>
          <a href="/Lahenga/2" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/57/ea/61/57ea61c94ddd1a8c481d43eebf5c8904.jpg" loading="lazy" alt="Photo by Galina N" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
        ...
        <div>
          <a href="/Lahenga/3" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/35/76/7c/35767cc5bec945debcb995de50b566e6.jpg" loading="lazy" alt="Photo by eniko kis" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
        ...
        <div>
          <a href="/Lahenga/4" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/7a/8b/2c/7a8b2ca3b733b09d281b68c3aae56016.jpg" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
        ...
        <div>
          <a href="/Lahenga/5" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/65/04/19/6504191cb955c31b8673805fd480512e.jpg" loading="lazy" alt="Photo by Charles Deluvio" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
        ...
        <div>
          <a href="/Lahenga/6" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/0c/9e/73/0c9e73e34ff268957dd1441b1ca3aea0.jpg" loading="lazy" alt="Photo by Fernando Lavin" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
        ...
        <div>
          <a href="/Lahenga/7" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/98/a3/e7/98a3e702eceb3b44d04800b70a808f67.jpg" loading="lazy" alt="Photo by Kiran CK" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
            <!-- <span class="bg-red-500 text-white text-sm tracking-wider uppercase rounded-br-lg absolute left-0 top-0 px-3 py-1.5">sale</span> -->
          </a>
        ...
        <div>
          <a href="/Lahenga/8" class="group h-80 block bg-gray-100 rounded-lg overflow-hidden relative mb-2 lg:mb-3">
            <img src="https://i.pinimg.com/236x/51/eb/45/51eb459b5f807c0a14f08f3a647ee26c.jpg" loading="lazy" alt="Photo by Fakurian Design" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
          </a>
